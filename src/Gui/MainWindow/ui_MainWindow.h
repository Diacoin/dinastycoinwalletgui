...
public:
    ...
    QAction *m_aboutdinastycoinAction;
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        QIcon icon;
        icon.addFile(QStringLiteral(":/images/dinastycoin"), QSize(), QIcon::Normal, QIcon::Off);
        ...
        m_aboutdinastycoinAction = new QAction(MainWindow);
        m_aboutdinastycoinAction->setObjectName(QStringLiteral("m_aboutdinastycoinAction"));
        m_aboutdinastycoinAction->setEnabled(true);
        ...
        menuHelp->addAction(m_aboutdinastycoinAction);
        ...
        QObject::connect(m_aboutdinastycoinAction, SIGNAL(triggered()), MainWindow, SLOT(about()));
    ...
    void retranslateUi(QMainWindow *MainWindow)
    {
...
#endif // QT_NO_TOOLTIP
        m_aboutdinastycoinAction->setText(QApplication::translate("MainWindow", "About dinastycoin", Q_NULLPTR));
        ...
        m_sendButton->setText(QApplication::translate("MainWindow", "SEND dinastyCOINS", Q_NULLPTR));
