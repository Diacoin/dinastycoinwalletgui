...
const char COMMUNITY_FORUM_URL[] = "https://dinasty-coin.herokuapp.com";
const char REPORT_ISSUE_URL[] = "https://dinastycoin.com/#contact";
...
MainWindow::MainWindow(ICryptoNoteAdapter* _cryptoNoteAdapter, IAddressBookManager* _addressBookManager,
  ...
  m_ui->setupUi(this);
  setWindowTitle(tr("dinastycoin Wallet 2.1.2h"));
